...
const stubComment = {
  comments: [
    { id: 0, articld_id: 0, author_id: 0, content: "TEST_COMMENT_0" },
    { id: 1, articld_id: 1, author_id: 1, content: "TEST_COMMENT_1" },
  ],
};
...
describe("ActionCreators", () => {
  ...
  it(`'postComment' should post comment correctly`, (done) => {
    const spy = jest.spyOn(axios, "post").mockImplementation((url, com) => {
      return new Promise((resolve, reject) => {
        const result = {
          status: 200,
          data: stubComment,
